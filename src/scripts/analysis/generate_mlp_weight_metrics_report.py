...
METRICS = {
    "expert_norm_fro": {
        "title": "Expert Weight Frobenius Norm",
        "ylabel": "Expert weight Frobenius norm",
        "filename_prefix": "expert_norm_fro",
    },
    "delta_norm_fro": {
        "title": "Delta Weight Frobenius Norm",
        "ylabel": "Delta Frobenius norm",
        "filename_prefix": "delta_norm_fro",
    },
    "relative_delta_norm": {
...
def main(
    ...
    output_dir: str = typer.Option(
        "/media/am/AM/FlexMoRE/src/scripts/analysis/results/expert_mlp_metrics_report_all_experts",
