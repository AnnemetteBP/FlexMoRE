...
def main(
    ...
    output_dir: str = typer.Option(
        "/media/am/AM/FlexMoRE/src/scripts/analysis/results/effective_ranks_v02v03",
    ),
    ...
    for expert_name, slug in EXPERTS:
        ...
        for row in provisional_rows:
            ...
            row["effective_rank_v02v03"] = weighted_rank
            rows.append(row)
        ...
        payload = {
            ...
            "summary": {
                ...
                "min_effective_rank_v02v03": min(weighted_ranks),
                "max_effective_rank_v02v03": max_rank,
                "mean_effective_rank_v02v03": sum(weighted_ranks) / len(weighted_ranks),
                "median_effective_rank_v02v03": sorted(weighted_ranks)[len(weighted_ranks) // 2],
